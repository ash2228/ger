    ...
    <>
      <div className='grid font-Oswald lg:grid-cols-2 gap-5 mt-10'>
        ...
        <div className='flex flex-col gap-5 bg-white p-5 rounded-3xl hover:bg-slate-900 hover:text-white cursor-default pr-20'>
          ...
          <p>Getashabeer is a dynamic web application built with cutting-edge technologies including Next.js, MongoDB, Vercel, and Auth.js. We are passionate about modern web development and adopting new technologies. Our team is dedicated to crafting an exceptional user experience while ensuring data security and accessibility for all.</p>
        </div>
        <div className='flex flex-col gap-5 bg-white p-5 rounded-3xl hover:bg-slate-900 hover:text-white cursor-default pr-20'>
          <h1 className='font-semibold'>What We Do:</h1>
          <p>Getashabeer is a Patreon project for showcasing payment gateway and authentication. By supporting, you can also get featured on the page.</p>
        </div>
        <div className='flex flex-col gap-5 bg-white p-5 rounded-3xl hover:bg-slate-900 hover:text-white cursor-default pr-20'>
        ...
        <div className='flex flex-col gap-5 bg-white p-5 rounded-3xl hover:bg-slate-900 hover:text-white cursor-default pr-20'>
          ...
          <ul>
            ...
            <li>
              ...
              <p>Your feedback is invaluable to us. Let us know what you love about Getashabeer and how we can make it even better.</p>
            </li>
          </ul>
        </div>
        <div className='flex flex-col gap-5 bg-white p-5 rounded-3xl hover:bg-slate-900 hover:text-white cursor-default pr-20'>
        ...
        <div className='flex flex-col gap-5 bg-white p-5 rounded-3xl hover:bg-slate-900 hover:text-white cursor-default pr-20'>
          ...
          <p>Have questions, suggestions, or just want to say hello? Reach out to us on our social media handles or preferred communication channels. Thank you for considering supporting Getashabeer. Together, we can drive change and make a difference!</p>
        </div>
      </div>
    </>
  );
