...
<div class="card flex-shrink-0 h-[400px] w-[300px] lg:h-[450px] lg:w-[350px] rounded-3xl ash bg-transparent lg:mt-20">
  ...
  <div onClick={()=>{window.location.href = "https://discord.gg/WsUDG3Ug3y"}} class="box box3"><span class="icon"><svg viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg" class="svg">
