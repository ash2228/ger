...
const Navbar = ()=>{
    ...
    <nav className="lg:flex justify-center">
        <div className="p-4">
            ...
            <div className={`${nav?"flex drop":"hidden"} lg:flex lg:flex-row lg:bg-transparent lg:relative lg:w-auto lg:h-auto lg:pt-0 lg:my-auto list-none z-10 top-0 pt-20 absolute bg-[#F5F5F7] w-[100vw] h-[100vh] font-semibold text-2xl gap-3 lg:gap-10 flex-col`}>
                ...
                <Link href={"/"} className="ml-[60px] lg:ml-0 lg:font-normal lg:text-xs" onClick={navHandler}>Signup</Link>
                <Link href={"/"} className="ml-[60px] lg:ml-0 lg:font-normal lg:text-xs" onClick={navHandler}>Login</Link>
